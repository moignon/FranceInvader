...
public class TriBlaster implements Weapon {
    ...
    public void Fire(Entite e) {
        ...
        tirs[0] = new Flamme(SpriteBank.get().getSprite(Constantes.flammeRef,1,4,60*1000000), e.getPanel());
        tirs[0].setCenteredPostion(e.getX()+ e.getL()/2, e.getY());
        tirs[0].setXspeed(0);
        tirs[0].setYspeed(-25);
        
        tirs[1] = new Flamme(SpriteBank.get().getSprite(Constantes.flammeRef,1,4,60*1000000), e.getPanel());
        tirs[1].setCenteredPostion(e.getX()+30+ e.getL()/2, e.getY()+30);
        tirs[1].setXspeed(2);
        tirs[1].setYspeed(-25);
        
        tirs[2] = new Flamme(SpriteBank.get().getSprite(Constantes.flammeRef,1,4,60*1000000), e.getPanel());
